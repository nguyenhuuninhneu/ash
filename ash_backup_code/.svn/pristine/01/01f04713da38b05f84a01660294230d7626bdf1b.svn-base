    ...
    public class GroupUserController : BaseController
    {
        ...
        public ActionResult Add(tbl_GroupUser obj)
        {
            try
            {
                ...
                LogController.AddLog(string.Format("Thêm mới nhóm người dùng: {0}", obj.Name), User.Username);
                return Json(new
                {
                    IsSuccess = true,
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                ...
                LogController.AddLog(string.Format("Xóa nhóm người dùng: {0}", obj.Name), User.Username);
            }
            catch (Exception)
            {
                return Json(new
        ...
        {
            var lstOrder = new List<tbl_AdminMenu>();
        ...
        public ActionResult AddUserToGroup(int id)
        {
            ...
            var lstUserUnAdd =
                lstUser.Where(
                    g =>
                        lstUserAdded.Count(t => t.ID == g.ID) == 0)
                    .ToList();
