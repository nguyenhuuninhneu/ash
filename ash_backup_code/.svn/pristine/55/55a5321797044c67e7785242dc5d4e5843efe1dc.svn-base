var position = function () {
    return {
        ...
        loadData: function (pageindex) {
            ...
            var self = this;
            $("#loading").show();
            AjaxService.POST("/Admin/position/ListData?page=" + pageindex, {category: category }, function (res) {
                ...
                if (res.totalPages > 1) {
                    ...
                    $('#pagination').twbsPagination({
                        ...
                        onPageClick: function (event, page) {
                            self.pageIndex = page;
                            position.loadData(self.pageIndex);
                        }
                    });
                }
        ...
        loadfrmAdd: function () {
            modal.Render("/Admin/position/Add", "Thêm mới vị trí", "modal-lg");
        },
        onAddSuccess: function (res) {
            if (res.IsSuccess == true) {
                alertmsg.success(res.Messenger);
                position.loadData(this.pageIndex);
                modal.hide();
            } else {
        ...
        loadfrmedit: function (id) {
            ...
            modal.Render("/Admin/position/Edit/" + id, "Cập nhật vị trí", "modal-lg");
        },
        ...
        active: function (id,str) {
            ...
            swal({
                ...
                if (isConfirm) {
                    AjaxService.POST("/Admin/position/ChangeStatus", { id: id, str: str}, function (res) {
                        self.pageIndex = 1;
        ...
        ondelete: function (id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    AjaxService.POST("/Admin/position/Delete", { id: id }, function (res) {
                        self.pageIndex = 1;
                        self.loadData(self.pageIndex);
                        alertmsg.success(res.Messenger);
                    });
        ...
        onmultidelete: function () {
            ...
            if ($("table tbody").find("input[type=checkbox]:checked").length == 0) {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        AjaxService.POST("/Admin/position/DeleteAll", { lstid: $("#hdfID").val() }, function (res) {
                            self.pageIndex = 1;
                            self.loadData(self.pageIndex);
                            alertmsg.success(res.Messenger);
                        });
        ...
        AjaxService.POST("/Admin/position/UpdatePosition", { value: strValue }, function (res) {
            if (res.IsSuccess == true) {
                alertmsg.success(res.Messenger);
                $("#gridData").html(res.ViewContent);
            } else {
