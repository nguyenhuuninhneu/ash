    ...
    var v = function (d, l) {
        ...
        return {
			...
			, {
				...
				, {
				    type: "button", id: "browse", className: "cke_dialog_image_browse", filebrowser: {
				        action: "Browse", target: "Link:txtUrl", url: d.config.filebrowserImageBrowseLinkUrl
				    }
					, style: "float:right", hidden: !0, label: d.lang.common.browseServer
				}
				, {
					...
					"_top"], [d.lang.common.targetSelf, "_self"], [d.lang.common.targetParent, "_parent"]], setup: function (a, b) {
			...
			, {
			    id: "advanced", label: d.lang.common.advancedTab, elements: [{
					...
					, {
						...
						""], [d.lang.common.langDirLtr, "ltr"], [d.lang.common.langDirRtl, "rtl"]], setup: function (a, b) {
