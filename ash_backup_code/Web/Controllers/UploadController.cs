...
namespace Web.Controllers
{
    public class UploadController : Controller
    {
        ...
        public JsonResult UploadFiles()
        {
            ...
            var videoExtention = new[] { "mp4", "avi", "flv", "mpeg","3gp","amv"};
            ...
            try
            {
                ...
                for (var i = 0; i < files.Count; i++)
                {
                    ...
                    #endregion
                    var ischat = Request.Form["ischat"];
                    if (ischat == "true")
                    {
                        path = string.Format("{0}/{1}", path, "Chats");
                    }
                    ...
                    } else if (videoExtention.Contains(extention))
                    {
