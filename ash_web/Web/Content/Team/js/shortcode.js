...
(function($) {
    ...
    // Start things up
    excellenceTheme.init();



    var flatOwl = function() {
        if ($().owlCarousel) {
            $('.excellencetheme-carousel-box').each(function() {
                var
                    $this = $(this),
                    auto = $this.data("auto"),
        ...
        $('textarea[name="message"]').each(function() {
            ...
            $('.btn-send button').on('click', function(e) {
                if (text.val() == '') {
                    ...
                    $('<div class="clearfix"></div><div class="message-in"><div class="message-pic"><img src="assets/images/avatar/message-1.png" alt=""><div class="pulse-css-1"></div></div><div class="message-body"><div class="message-text"><p>' + text.val() + '</p></div><div class="message-meta"><p>Sunday, march 17, 2021 at 2:59 PM</p></div></div></div>').appendTo('div.message-box');
                    text.val('');
    ...
    var flatCounter = function() {
        if ($().countTo) {
            $('.excellencetheme-counter').on('on-appear', function() {
